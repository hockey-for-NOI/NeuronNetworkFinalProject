...
import os
import time
from model_ex_rearr import Model_rearr
...
def work(n_split):
    ...
    mlp_model = Model_rearr(True)

    model_pref = "CNN_std_{}split_rearr1".format(n_split)
    train_dir = "{}_CNN_std_{}split_rearr1".format(FLAGS.train_dir_pref, n_split)

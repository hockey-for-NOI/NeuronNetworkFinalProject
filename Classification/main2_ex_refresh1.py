...
import os
import time
from model_ex_refresh import Model_refresh
...
def work(n_split):
    ...
    mlp_model = Model_refresh(True)

    model_pref = "CNN_std_{}split_refresh1".format(n_split)
    train_dir = "{}_CNN_std_{}split_refresh1".format(FLAGS.train_dir_pref, n_split)

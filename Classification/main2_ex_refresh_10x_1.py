...
import os
import time
from model_ex_refresh_10x import Model_refresh_10x
...
def work(n_split):
    ...
    model_pref = "CNN_std_{}split_refresh_10x_1".format(n_split)
    train_dir = "{}_CNN_std_{}split_refresh_10x_1".format(FLAGS.train_dir_pref, n_split)

...
import os
import time
from model_rearr_10x import Model_rearr_10x
...
def work(n_split):
    ...
    model_pref = "MLP_std_{}split_rearr_10x_1".format(n_split)
    train_dir = "{}_std_{}split_rearr_10x_1".format(FLAGS.train_dir_pref, n_split)

...
import os
import time
from model_refresh import Model_refresh
...
def work(n_split):
    ...
    model_pref = "MLP_std_{}split_refresh1".format(n_split)
    train_dir = "{}_std_{}split_refresh1".format(FLAGS.train_dir_pref, n_split)

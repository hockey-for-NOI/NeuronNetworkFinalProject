...
import os
import time
from modelx_extra import Model
from load_data_with_max import load_data
...
def work(n_split):
    ...
    model_pref = "CNN_std_{}split_max".format(n_split)
    train_dir = "{}_CNN_std_{}split_max".format(FLAGS.train_dir_pref, n_split)
